...
# Python service: cached-token evidence is now part of the strict terminal wire ABI.
replace_once(
...
# Canonical usage is now genuinely reported, not inferred. This is the value the
# run ledger/telemetry already knows how to retain.
replace_once(
