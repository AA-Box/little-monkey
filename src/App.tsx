  ...
  return (
    <div className="flex h-screen w-screen bg-background text-foreground">
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col">
        ...
        <ErrorBoundary resetKey={globalSearchOpen ? "global-search" : agentInboxOpen ? "agent-inbox" : dailyBriefOpen ? "daily-brief" : deepResearchOpen ? "deep-research" : runCenterOpen ? "run-center" : browserWorkbenchOpen ? `browser-${activeSessionId}` : activeComparisonId ?? activeCrewSessionId ?? activeSessionId}>
          {globalSearchOpen ? (
            <GlobalSearch
      ...
      {!globalSearchOpen && !agentInboxOpen && !dailyBriefOpen && !deepResearchOpen && !runCenterOpen && !browserWorkbenchOpen && activeComparisonId === null && activeCrewSessionId === null && splitSessionId !== null && (
