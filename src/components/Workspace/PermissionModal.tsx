...
import { AlertTriangle, FilePenLine, FileText, Folder, Search, TerminalSquare } from "lucide-react";
 ...
 * before running a sensitive tool (write_file / edit_file / run_shell).
