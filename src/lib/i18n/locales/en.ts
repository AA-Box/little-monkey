...
export const en: Record<string, string> = {
  ...
  "ConnectorsPanel.airtableCopy": "Signs in to Airtable with read-only email and base-schema scopes. Airtable requires PKCE and publishes no revoke endpoint — revoke in Airtable's own settings.",
  ...
  "ConnectorsPanel.oauthSecretHint_never": "This provider registers public clients only, so there is no secret. The client ID is saved in your OS keychain — leave it blank to reuse the app you already registered for this provider.",
