...
export const en: Record<string, string> = {
  ...
  "EffortSelector.effortDescription": "Applies to this model only. Higher effort means more thorough responses, but takes longer and uses your limits faster. Default leaves the choice to the provider.",
