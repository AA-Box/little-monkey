export const en: Record<string, string> = {
  ...
  "AutomationPanel.subagentsEnabledDescription": "Let the model delegate a scoped subtask (e.g. broad exploration) to a subagent with its own isolated, read-only tool-calling loop. Only a final report is returned to the conversation, keeping exploration noise out of your context.",
