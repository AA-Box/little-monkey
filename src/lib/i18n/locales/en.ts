export const en: Record<string, string> = {
  ...
  "AddMcpServerForm.heading": "Add MCP server (stdio)",
  ...
  "AddMcpServerForm.helpText": "Stdio servers run as a child process on your machine. Remote (HTTP) servers are coming in a later update.",
