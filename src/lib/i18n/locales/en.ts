...
export const en: Record<string, string> = {
  ...
  "AppMenu.backgroundTasks": "Background Tasks",
  ...
  "App.openSideTaskPane": "Open side tasks",
  "App.closeSideTaskPane": "Close side tasks",
  "App.sideTaskPaneTitle": "Side tasks",
  ...
  "ReviewPanel.oversizeFile": "File too large to diff.",
  "ReviewPanel.loadingFile": "Loading this file's diff…",
  "ReviewPanel.notLoadedFile": "Open this file to load its diff.",
  "ReviewPanel.selectHint": "Select a file to see its changes.",
  "ReviewPanel.switchToSingle": "Show one file at a time",
  "ReviewPanel.switchToContinuous": "Show every file in one scroll",
  "ReviewPanel.oldTitle": "HEAD",
  "ReviewPanel.oldTitleBranch": "Merge base",
  "ReviewPanel.newTitle": "Working tree",
  ...
  "App.rightPanelBackgroundTasks": "Background tasks",
  "App.rightPanelProcesses": "Processes",
  "App.openProcesses": "Show processes",
  "App.closeProcesses": "Hide processes",
  ...
  "TerminalPanel.searchResults": "{{current}} of {{count}}",
  "TerminalPanel.noSearchResults": "No matches. Try a shorter search.",
  "TerminalPanel.previousMatch": "Previous match",
  ...
  "AttachmentChip.showInFinder": "Show in Finder",
  ...
  "ChatSessionList.gitBranchAriaLabel": "Git branch {{branch}}",
  "ChatSessionList.gitContextTitle": "Git context",
  "ChatSessionList.gitPullRequest": "Pull request",
  "ChatSessionList.gitCompareBranch": "Compare branch",
  "ChatSessionList.gitChecksSuccessful": "Checks successful",
  "ChatSessionList.gitChecksFailed": "Checks failed",
  "ChatSessionList.gitWorkingTreeClean": "Working tree clean",
  "ChatSessionList.gitFilesChanged": "{{count}} changed file(s)",
  "ChatSessionList.gitChecksNotLoaded": "Checks not loaded",
  "ChatSessionList.gitLoading": "Loading Git context…",
  "ChatSessionList.status.working": "Working",
  "ChatSessionList.status.attention": "Waiting for you",
  "ChatSessionList.status.error": "Failed",
  "ChatSessionList.status.finished": "Finished",
  "ChatSessionList.view.menuAriaLabel": "Filter and sort sessions",
  "ChatSessionList.view.status": "Status",
  "ChatSessionList.view.status.active": "Active",
  "ChatSessionList.view.status.archived": "Archived",
  "ChatSessionList.view.status.all": "All",
  "ChatSessionList.view.environment": "Environment",
  "ChatSessionList.view.environmentAll": "All environments",
  "ChatSessionList.view.environmentCount": "{{count}} selected",
  "ChatSessionList.view.environment.local": "Local",
  "ChatSessionList.view.environment.remoteControl": "Remote Control",
  "ChatSessionList.view.groupBy": "Group by",
  "ChatSessionList.view.groupBy.date": "Date",
  "ChatSessionList.view.groupBy.folder": "Folder",
  "ChatSessionList.view.groupBy.state": "State",
  "ChatSessionList.view.groupBy.groups": "Custom groups",
  "ChatSessionList.view.groupBy.none": "None",
  "ChatSessionList.view.sortBy": "Sort by",
  "ChatSessionList.view.sortBy.alphabetical": "Alphabetically",
  "ChatSessionList.view.sortBy.created": "Created time",
  "ChatSessionList.view.sortBy.recency": "Recency",
  "ChatSessionList.view.today": "Today",
  "ChatSessionList.view.yesterday": "Yesterday",
  "ChatSessionList.view.lastWeek": "Previous 7 days",
  "ChatSessionList.view.older": "Older",
  "ChatSessionList.view.noFolder": "No folder",
  ...
  "ExternalConversation.deleteConfirm": "Delete \"{{title}}\" from this machine? Everything recorded here about it is erased. The provider keeps its own copy.",
  ...
  "CheckpointPreview.effectKind.device": "A paired device used its own hardware",
  "CheckpointPreview.effectKind.desktop-control": "Input was sent to another application",
  ...
  "CodeBlock.runInTerminal": "Run in terminal",
  "CodeBlock.openInTerminal": "Open in terminal",
  "CodeBlock.running": "Running…",
  "CodeBlock.noWorkspace": "Open a workspace folder first — the terminal runs inside it.",
  ...
  "WorkspaceImage.loading": "Loading image…",
  ...
  "GeneratedImage.downloadButton": "Download PNG",
  "GeneratedImage.copyButton": "Copy image",
  "GeneratedImage.moreButton": "More",
  ...
  "MessageList.learningSuggested": "Reusable procedure suggested",
  "MessageList.learningInstalled": "Learned skill installed",
  ...
  "BackgroundTasksPanel.title": "Background tasks",
  "ProcessesPanel.title": "Processes",
  "ProcessesPanel.closeAriaLabel": "Close processes",
  "ProcessesPanel.refreshAriaLabel": "Refresh process list",
  "ProcessesPanel.dismissError": "Dismiss",
  "ProcessesPanel.emptyState": "Nothing is running right now.",
  "ProcessesPanel.pid": "pid {{pid}}",
  "ProcessesPanel.pausePendingHint": "Lands at the next safe point.",
  "ProcessesPanel.suspendAriaLabel": "Pause {{name}}",
  "ProcessesPanel.resumeAriaLabel": "Resume {{name}}",
  "ProcessesPanel.stopAriaLabel": "Stop {{name}}",
  "ProcessesPanel.stateAdmitted": "Queued",
  "ProcessesPanel.stateRunning": "Running",
  "ProcessesPanel.stateSuspended": "Paused",
  "ProcessesPanel.statePausePending": "Pausing",
  "ProcessesPanel.stateStopping": "Stopping",
  "ProcessesPanel.stateExited": "Exited",
  "ProcessesPanel.kindChatTurn": "Chat turn",
  "ProcessesPanel.kindDaemonJob": "Daemon job",
  "ProcessesPanel.kindSubagent": "Subagent",
  "ProcessesPanel.kindCrewMember": "Crew member",
  "ProcessesPanel.kindWorkflowRun": "Workflow run",
  "ProcessesPanel.kindWorkflowNode": "Workflow node",
  "ProcessesPanel.kindRemoteRun": "Remote run",
  "ProcessesPanel.kindBackgroundShell": "Background shell",
  "ProcessesPanel.kindSideTask": "Side task",
  "ProcessesPanel.kindForegroundShell": "Shell command",
  "ProcessesPanel.kindBrowserSession": "Browser session",
  "ProcessesPanel.resourcesToggle": "Limits",
  "ProcessesPanel.resourcesAriaLabel": "Resource limits and enforcement",
  "ProcessesPanel.resourceBackend": "Enforced here by: {{backend}}",
  "ProcessesPanel.resourceTree": "Tree owned by: {{primitive}}",
  "ProcessesPanel.limitWall": "Wall time",
  "ProcessesPanel.limitMemory": "Memory",
  "ProcessesPanel.limitOutput": "Output",
  "ProcessesPanel.limitChildProcesses": "Child processes",
  "ProcessesPanel.limitContextTokens": "Context tokens",
  "ProcessesPanel.limitUnbounded": "no limit",
  "ProcessesPanel.enforcementKernel": "Kernel",
  "ProcessesPanel.enforcementSupervised": "Supervised",
  "ProcessesPanel.enforcementOwnerSourced": "Owner-sourced",
  ...
  "ProcessesPanel.kindHookCommand": "Hook",
  ...
  "ProcessesPanel.breachConfigured": "Configured: {{configured}}",
  ...
  "ResourceLedgerPanel.field_wallTimeMs": "Wall time",
  "ResourceLedgerPanel.field_cpuTimeMs": "CPU time",
  "ResourceLedgerPanel.field_peakRssBytes": "Peak RSS",
  "ResourceLedgerPanel.field_bytesRead": "Bytes read",
  "ResourceLedgerPanel.field_bytesWritten": "Bytes written",
  "ResourceLedgerPanel.field_bytesEgressed": "Bytes egressed",
  "ResourceLedgerPanel.field_tokensIn": "Tokens in",
  "ResourceLedgerPanel.field_tokensOut": "Tokens out",
  "ResourceLedgerPanel.field_gpuResidentBytes": "GPU resident",
  "ResourceLedgerPanel.field_gpuDeviceMs": "GPU device time",
  "ResourceLedgerPanel.kind_chat_turn": "Chat turn",
  "ResourceLedgerPanel.kind_daemon_job": "Daemon job",
  "ResourceLedgerPanel.kind_subagent": "Subagent",
  "ResourceLedgerPanel.kind_crew_member": "Crew member",
  "ResourceLedgerPanel.kind_workflow_run": "Workflow run",
  "ResourceLedgerPanel.kind_workflow_node": "Workflow node",
  "ResourceLedgerPanel.kind_remote_run": "Remote run",
  "ResourceLedgerPanel.kind_background_shell": "Background shell",
  "ResourceLedgerPanel.kind_side_task": "Side task",
  "ResourceLedgerPanel.exit_succeeded": "Succeeded",
  "ResourceLedgerPanel.exit_failed": "Failed",
  "ResourceLedgerPanel.exit_cancelled": "Cancelled",
  "ResourceLedgerPanel.exit_limit_exceeded": "Limit exceeded",
  "ResourceLedgerPanel.exit_lost": "Lost",
  "ResourceLedgerPanel.exit_needs_reconciliation": "Needs reconciliation",
  "ResourceLedgerPanel.exit_containment_lost": "Containment lost after restart",
  "ResourceLedgerPanel.kind_foreground_shell": "Foreground shell",
  "ResourceLedgerPanel.kind_browser_session": "Browser session",
  ...
  "ResourceLedgerPanel.outcomePreempted": "Preempted",
  "ResourceLedgerPanel.outcomeResumed": "Resumed",
  "ResourceLedgerPanel.outcomeRejected": "Rejected",
  "BackgroundAgentsPanel.backpressureLabel": "Backpressure",
  "BackgroundAgentsPanel.backpressureQueueLabel": "Queue depth",
  ...
  "BackgroundTasksPanel.toolCallCountOne": "1 tool use",
  "BackgroundTasksPanel.toolCallCountMany": "{{count}} tool uses",
  "BackgroundTasksPanel.shellStatusRunning": "Running",
  "BackgroundTasksPanel.shellStatusExited": "Exited",
  "BackgroundTasksPanel.shellStatusStopped": "Stopped",
  "BackgroundTasksPanel.shellStatusExitCode": "Exit {{code}}",
  "BackgroundTasksPanel.shellStatusFailed": "Failed",
  "BackgroundTasksPanel.agentStatusRunning": "Running",
  "BackgroundTasksPanel.agentStatusCompleted": "Completed",
  "BackgroundTasksPanel.agentStatusFailed": "Failed",
  "BackgroundTasksPanel.agentStatusCancelled": "Cancelled",
  ...
  "BackgroundTasksPanel.tableToolsHeader": "Tools",
  "BackgroundTasksPanel.tableTimeHeader": "Time",
  ...
  "SubagentRow.worktreeChanges": "Changes in worktree",
  "SubagentRow.worktreeApply": "Apply",
  "SubagentRow.worktreeDiscard": "Discard",
  "SubagentRow.worktreeApplied": "Applied to workspace",
  "SubagentRow.worktreeDiscarded": "Discarded",
  ...
  "ModelSwitcher.addModelHint": "Add a cloud, local, or Ollama model without leaving chat.",
  ...
  "AddCustomModelForm.openGgufDescription": "Open a `.gguf` file, or a model folder, already on your computer",
  ...
  "AddCustomModelForm.projectorLabel": "Multimodal projector",
  ...
  "AddCustomModelForm.projectorAttached": "Projector attached",
  "AddCustomModelForm.noProjector": "No projector",
  "AddCustomModelForm.chooseProjectorOption": "Choose a projector",
  "AddCustomModelForm.projectorFileFilter": "GGUF projector",
  "AddCustomModelForm.cancelInstallButton": "Cancel install",
  ...
  "AddCustomModelForm.publicSingleFileOnly": "Public GGUF model bundles are supported. Private or gated repositories and split GGUF files are not supported.",
  ...
  "ModelManager.projectorFileFilter": "GGUF projector",
  ...
  "AddModelDialog.subtitle": "Choose where the model runs, then connect or install it here.",
  "AddModelDialog.chooseProviderPrompt": "Choose a provider to connect it and pick a model.",
  "AddModelDialog.pickModelPrompt": "Pick a model to use it in this chat.",
  "AddModelDialog.apiKeyLabel": "API key for {{provider}}",
  "AddModelDialog.customApiKeyLabel": "API key for the custom provider",
  "AddModelDialog.keyStorageHint": "Stored in your OS keychain only.",
  "AddModelDialog.useModelAction": "Use",
  ...
  "AutomationPanel.dispatchEnableButton": "Enable",
  "AutomationPanel.dispatchDisableButton": "Disable",
  "AutomationPanel.dispatchMoveUpLabel": "Move policy up",
  "AutomationPanel.dispatchMoveDownLabel": "Move policy down",
  "AutomationPanel.dispatchRemoveLabel": "Delete policy",
  ...
  "SettingsModal.tabConnectors": "Connectors (MCP)",
  "SettingsModal.tabChannels": "Messaging channels",
  ...
  "PeersPanel.cancel": "Cancel",
  "PeersPanel.refresh": "Refresh",
  "PeersPanel.refreshed": "Peer list refreshed.",
  "PeersPanel.inviteLabel": "Peer name",
  "PeersPanel.acceptAlias": "Local name",
  "PeersPanel.acceptFile": "Invitation file",
  "PeersPanel.chooseFile": "Choose file…",
  "PeersPanel.noFileSelected": "No file chosen yet",
  "PeersPanel.certificateFingerprint": "Certificate fingerprint",
  "PeersPanel.direction": "Direction",
  "PeersPanel.directionInbound": "Can reach this installation",
  "PeersPanel.directionOutbound": "This installation can reach it",
  "PeersPanel.role": "Role",
  "PeersPanel.rolePeer": "Peer",
  "PeersPanel.roleMixed": "Peer and controller device",
  "PeersPanel.advertised": "They support",
  "PeersPanel.requested": "They asked for",
  "PeersPanel.granted": "You granted",
  "PeersPanel.presenceOnline": "Answered recently",
  "PeersPanel.presenceOffline": "Not answering",
  "PeersPanel.presenceUnknown": "Never in touch",
  "PeersPanel.lastSeen": "Last seen {{time}}",
  "PeersPanel.lastSeenNever": "never",
  "PeersPanel.keyGeneration": "key generation {{generation}}",
  "PeersPanel.refreshStatus": "Check now",
  ...
  "PeersPanel.messageId": "Message",
  "PeersPanel.correlation": "Correlation",
  "PeersPanel.notSupplied": "none",
  "PeersPanel.messageInbound": "from the peer",
  "PeersPanel.messageOutbound": "from here",
  "PeersPanel.kindMessage": "Message",
  "PeersPanel.kindTask": "Task request",
  "PeersPanel.kindResult": "Result",
  "PeersPanel.kindArtifact": "Artifact",
  "PeersPanel.statusAccepted": "Accepted",
  ...
  "PeersPanel.sentSucceeded": "Finished",
  "PeersPanel.sentFailed": "Failed there",
  "PeersPanel.sentCancelled": "Cancelled there",
  "PeersPanel.sentRejected": "Refused there",
  ...
  "ChannelsPanel.health_connecting": "Connecting",
  "ChannelsPanel.health_connected": "Connected",
  "ChannelsPanel.health_degraded": "Degraded",
  ...
  "ChannelsPanel.policy_disabled": "Nobody",
  "ChannelsPanel.policy_allow_list": "Approved senders only",
  "ChannelsPanel.policy_pairing": "Strangers get a pairing code",
  "ChannelsPanel.policy_open": "Anyone",
  "ChannelsPanel.activation_always": "Every message",
  "ChannelsPanel.activation_mention_only": "Only when mentioned",
  "ChannelsPanel.activation_disabled": "Never",
  "ChannelsPanel.pendingSenders": "Waiting for approval",
  ...
  "ChannelsPanel.approvedSenders": "Approved",
  "ChannelsPanel.noApprovedSenders": "Nobody has been approved yet.",
  "ChannelsPanel.revoke": "Revoke access",
  "ChannelsPanel.senderRevoked": "Revoked. This sender is blocked and their messages are ignored.",
  "ChannelsPanel.blockedSenders": "Blocked",
  "ChannelsPanel.noBlockedSenders": "Nobody is blocked.",
  "ChannelsPanel.forgetSender": "Forget",
  "ChannelsPanel.senderForgotten": "Forgotten. Their next message meets the pairing challenge again, and any model they picked is gone.",
  "ChannelsPanel.defaultModel": "default model",
  "ChannelsPanel.activity": "Recent activity",
  "ChannelsPanel.noActivity": "No messages recorded yet.",
  "ChannelsPanel.refresh": "Refresh",
  "ChannelsPanel.addAccount": "Add an account",
  ...
  "IngressTurns.empty": "Nothing has arrived yet.",
  "IngressTurns.event": "Event",
  "IngressTurns.state": "Turn",
  "IngressTurns.attempts": "Attempts",
  "IngressTurns.job": "Job",
  "IngressTurns.run": "Run",
  "IngressTurns.snapshot": "Frozen config",
  "IngressTurns.status.waiting": "Waiting",
  "IngressTurns.status.running": "Running",
  "IngressTurns.status.done": "Done",
  "IngressTurns.status.failed": "Failed",
  "IngressTurns.contract": "File change",
  "IngressTurns.contractPending": "Checking",
  "IngressTurns.contractState.satisfied": "Made",
  "IngressTurns.contractState.corrected": "Retried",
  "IngressTurns.contractState.unmet": "Not made",
  "IngressTurns.contractState.interrupted": "Unknown — the run stopped",
  "IngressTurns.continuation": "Continues",
  "IngressTurns.continuationKind.mutation_correction": "Corrective attempt",
  "IngressTurns.continuationKind.resume": "Resumed turn",
  "ChannelsPanel.recipe": "Task",
  "ChannelsPanel.scope": "Applies to",
  "ChannelsPanel.scopeAccount": "The selected account",
  ...
  "ChannelsPanel.recipePick": "Choose a task",
  "ChannelsPanel.recipeMissingOption": "{{name}} — not saved any more",
  "ChannelsPanel.recipeMissing": "No task by this name is saved, so every message this route matches fails. Pick one that exists.",
  "ChannelsPanel.starterRoute": "Set up a starter task and route",
  "ChannelsPanel.starterRouteHint": "Creates a task named channel-chat that answers the message, read-only, and points every account at it. Edit it later in Settings > Tasks.",
  "ChannelsPanel.starterRecipe": "Create a starter task",
  "ChannelsPanel.editRoute": "Edit",
  "ChannelsPanel.saveRoute": "Save route",
  "ChannelsPanel.routeDisabled": "Off",
  "ChannelsPanel.cancel": "Cancel",
  "ChannelsPanel.specificity_sender": "Sender",
  "ChannelsPanel.specificity_thread": "Thread",
  "ChannelsPanel.specificity_conversation": "Conversation",
  "ChannelsPanel.specificity_account": "Account",
  "ChannelsPanel.specificity_channel_default": "Provider",
  "ChannelsPanel.specificity_global_default": "Everything",
  "ChannelsPanel.level_sender": "One sender in one thread",
  "ChannelsPanel.level_thread": "One thread",
  "ChannelsPanel.level_conversation": "One conversation",
  "ChannelsPanel.level_account": "One account",
  "ChannelsPanel.level_provider": "Every account of one provider",
  "ChannelsPanel.level_global": "Everything else",
  ...
  "ChannelsPanel.repositoryPlaceholder": "Folder the run gets, if any",
  "ChannelsPanel.sessionScope": "Keeps history per",
  "ChannelsPanel.sessionScope_thread": "Thread",
  "ChannelsPanel.sessionScope_conversation": "Conversation",
  "ChannelsPanel.sessionScope_sender": "Sender",
  "ChannelsPanel.sessionScope_account": "Account",
  ...
  "ChannelsPanel.routeModel": "Model",
  "ChannelsPanel.routeModelHint": "The model this route's task answers on. Stored in the task's own target, which is what the runner reads when a message arrives.",
  "ChannelsPanel.routeModelUnset": "No model set",
  "ChannelsPanel.routeModelUnavailable": "Not available on this machine right now. It stays saved until you pick another one.",
  "ChannelsPanel.routeModelUnavailableOption": "{{label}} — not available here",
  "ChannelsPanel.routeModelGroupLocal": "Local",
  "ChannelsPanel.routeModelGroupOllama": "Ollama",
  "ChannelsPanel.routeModelEmpty": "No models are available yet. Install a local model, start Ollama, or connect a provider.",
  "ChannelsPanel.routeModelShared": "{{count}} routes use this task, so they all answer on this model.",
  "ChannelsPanel.routeModelUnknownRecipe": "This task is not saved, so it has no model to show.",
  ...
  "TelephonyPanel.health_unconfigured": "Not set up",
  "TelephonyPanel.health_disconnected": "Not checked yet",
  "TelephonyPanel.health_connecting": "Connecting",
  "TelephonyPanel.health_connected": "Connected",
  ...
  "TelephonyPanel.inbound_answer": "Answer and talk",
  "TelephonyPanel.outboundApproval": "Calling out",
  ...
  "TelephonyPanel.noCalls": "No calls recorded yet.",
  "TelephonyPanel.inbound": "In",
  "TelephonyPanel.outbound": "Out",
  "TelephonyPanel.addNumber": "Add a number",
  "TelephonyPanel.carrier": "Carrier",
  "TelephonyPanel.label": "Name",
  "TelephonyPanel.labelPlaceholder": "Support line",
  "TelephonyPanel.carrierAccountId": "Carrier account id",
  ...
  "SettingsModal.tabResourceLedger": "Resource Ledger",
  ...
  "AppearancePanel.densitySpacious": "Spacious",
  "AppearancePanel.sidebarLabel": "Sidebar layout",
  "AppearancePanel.sidebarCompact": "Compact",
  "AppearancePanel.sidebarStandard": "Standard",
  "AppearancePanel.sidebarWide": "Wide",
  "AppearancePanel.bubblesLabel": "Chat style",
  "AppearancePanel.bubblesRounded": "Rounded bubbles",
  ...
  "RulesMemoryPanel.memoryStudioPointer": "This list covers only the current project plus global facts that currently reach the prompt. For every memory across every project — including disabled, expired, and merged-away ones, plus import/export — open the Memory Studio tab.",
  ...
  "RulesMemoryPanel.memoryClearConfirmPrompt": "Delete every remembered fact saved for this project — including any that are disabled, expired, or kept only so a merge can be undone? Global facts are listed above but are not affected. This can't be undone.",
  ...
  "MemoryStudioPanel.intro": "Every durable memory this app has stored, across every project and the global scope — inspect, edit, pin, merge, expire, disable, delete, import, and export them here.",
  "MemoryStudioPanel.honestyNote": "This app's memory store has exactly two scopes: \"global\" (applies to every project) and \"project\" (one workspace root). There is no separate workspace, user, device, or connector scope, and no confidence score. Pinned memories are folded in first and never expire or count against the 100-memory per-scope cap (20 pins per scope). Expiry is checked when a prompt is assembled, not by a background job, so an expired memory stays on disk until you purge it — and Purge expired clears every scope at once, not just the one you are filtering. Merging keeps the originals, retired and restorable; a purge removes them only when the memory they were merged into is itself expired and purged, and undoing a merge discards the merged memory along with any edit you made to it — a merge that has itself been merged into a newer one has to wait for that newer merge to be undone first. \"Last used\" is stamped when a prompt is built from a memory, to within an hour, not per model call, and chat answers still don't cite which memory they drew on. A turn already queued to the background daemon replays the prompt frozen when it was queued, so disabling, expiring or merging a memory takes effect from the next prompt, not for work already in the queue.",
  ...
  "MemoryStudioPanel.filterStateActive": "Active",
  "MemoryStudioPanel.filterPinned": "Pinned",
  "MemoryStudioPanel.filterExpired": "Expired",
  "MemoryStudioPanel.filterMerged": "Merged",
  "MemoryStudioPanel.filterRetired": "Retired by merge",
  "MemoryStudioPanel.pinButton": "Pin",
  "MemoryStudioPanel.unpinButton": "Unpin",
  "MemoryStudioPanel.statusPinned": "pinned",
  "MemoryStudioPanel.statusExpired": "expired",
  "MemoryStudioPanel.statusRetired": "retired by merge",
  "MemoryStudioPanel.statusMerged": "merged from {{count}}",
  "MemoryStudioPanel.expiredReason": "Expired {{date}} — excluded from prompts until you clear the expiry, and still on disk until you purge it.",
  "MemoryStudioPanel.retiredReason": "Merged into another memory {{date}} — kept so the merge can be undone and never sent to the model. Purge expired leaves it alone unless the memory it was merged into is itself expired and purged, which takes this one with it.",
  "MemoryStudioPanel.mergedFromTitle": "Original memory ids: {{ids}}",
  "MemoryStudioPanel.expiryLabel": "Expires",
  "MemoryStudioPanel.expiryHint": "A date expires at the end of that day.",
  "MemoryStudioPanel.expiryPinnedHint": "Pinned memories never expire — unpin this one to give it an expiry.",
  "MemoryStudioPanel.expiryPinnedRetainedHint": "Pinned, so this memory is exempt from its {{date}} expiry and stays in prompts — unpinning it applies that date again. Clear expiry removes it for good.",
  "MemoryStudioPanel.expiryClearButton": "Clear expiry",
  "MemoryStudioPanel.lastUsed": "Last folded into a prompt {{date}} (recorded to within an hour)",
  "MemoryStudioPanel.lastUsedNever": "Never folded into a prompt yet",
  "MemoryStudioPanel.selectLabel": "Select for merge",
  "MemoryStudioPanel.mergeSelectedButton": "Merge {{count}} selected",
  "MemoryStudioPanel.mergingButton": "Merging…",
  "MemoryStudioPanel.mergeTextPlaceholder": "The combined memory (leave blank to join the originals)…",
  "MemoryStudioPanel.mergeConfirmButton": "Merge",
  "MemoryStudioPanel.mergeMinWarning": "Merging needs at least two memories — select another one.",
  "MemoryStudioPanel.mergeScopeWarning": "Memories can only be merged within one scope — deselect the ones from another project or the global scope.",
  "MemoryStudioPanel.mergeComplete": "Merged {{count}} memories into one. The originals are kept, retired, and can be restored.",
  "MemoryStudioPanel.unmergeButton": "Undo merge",
  "MemoryStudioPanel.unmergeComplete": "Restored {{count}} original memories. The merged memory is gone, along with any edit made to it.",
  "MemoryStudioPanel.deleteMergedWarning": "Deleting this also deletes the {{count}} originals it retired.",
  "MemoryStudioPanel.purgeButton": "Purge expired",
  "MemoryStudioPanel.purgingButton": "Purging…",
  "MemoryStudioPanel.purgeConfirmButton": "Purge every scope",
  "MemoryStudioPanel.purgeComplete": "Purged {{count}} expired memories, across every scope — plus any originals they had retired.",
  "MemoryStudioPanel.purgeNone": "No expired memories to purge.",
  ...
  "McpPanel.oauthConnected": "OAuth credentials saved",
  "McpPanel.oauthConnectButton": "Connect via OAuth",
  "McpPanel.oauthConnectingButton": "Connecting…",
  "McpPanel.oauthReauthorizeButton": "Reauthorize",
  "McpPanel.oauthReauthorizingButton": "Reauthorizing…",
  ...
  "McpPanel.oauthPhase_idle": "Not started",
  "McpPanel.oauthPhase_verifying": "Verifying your account…",
  "ConnectorsPanel.description": "Connect a work account without hand-editing raw MCP config: eleven providers over OAuth using an app you register once, Slack/Notion/Jira with a pasted token, GitHub through the gh CLI, and S3/R2 with access keys. Every credential is verified live before it's saved, and stored in your OS keychain only. A connected account records who you are there and what scopes were granted; no feature reads provider data through it yet.",
  "ConnectorsPanel.nonGoalNotice": "Little Monkey ships no OAuth client credentials of its own — it's open source, so anything baked in would be readable by anyone. Connecting an account over OAuth always uses an OAuth app you register yourself, once per provider, against the fixed redirect URI shown on its card.",
  ...
  "ConnectorsPanel.appFilterCategoryHeading": "Category",
  "ConnectorsPanel.appFilterClearButton": "Clear",
  "ConnectorsPanel.appSortDefault": "Default",
  "ConnectorsPanel.appSortAlphabetical": "Alphabetical",
  "ConnectorsPanel.appNoMatch": "No connectors match your search or filters.",
  "ConnectorsPanel.appConnectButton": "Connect",
  "ConnectorsPanel.appConnectingButton": "Connecting…",
  "ConnectorsPanel.appReauthorizeButton": "Reauthorize",
  "ConnectorsPanel.appReauthorizingButton": "Reauthorizing…",
  "ConnectorsPanel.appCancelButton": "Cancel",
  ...
  "ConnectorsPanel.appOauthPhase_connected": "Connected",
  "ConnectorsPanel.appOauthPhase_error": "Failed",
  "ConnectorsPanel.appOauthPhase_cancelled": "Cancelled",
  "ConnectorsPanel.categoryDevTools": "Development tools",
  "ConnectorsPanel.categoryCommunication": "Communication",
  "ConnectorsPanel.categoryProductivity": "Productivity & project management",
  "ConnectorsPanel.categoryCloudStorage": "Cloud storage & files",
  "ConnectorsPanel.categoryCreative": "Creative & design",
  "ConnectorsPanel.categoryCommerce": "Commerce & shopping",
  "ConnectorsPanel.categoryFinancial": "Financial services",
  "ConnectorsPanel.categoryDataAnalytics": "Data & analytics",
  "ConnectorsPanel.categoryCrm": "Sales & CRM",
  ...
  "ConnectorsPanel.providerExtension": "Extension-supplied",
  "ConnectorsPanel.providerGoogleDrive": "Google Drive",
  "ConnectorsPanel.providerMicrosoftGraph": "Microsoft 365",
  "ConnectorsPanel.providerLinear": "Linear",
  "ConnectorsPanel.providerAsana": "Asana",
  "ConnectorsPanel.providerDropbox": "Dropbox",
  "ConnectorsPanel.providerBox": "Box",
  "ConnectorsPanel.providerAirtable": "Airtable",
  "ConnectorsPanel.providerZendesk": "Zendesk",
  "ConnectorsPanel.providerHubspot": "HubSpot",
  "ConnectorsPanel.providerDiscord": "Discord",
  "ConnectorsPanel.providerGitlab": "GitLab",
  ...
  "ConnectorsPanel.oauthHeading": "Connect over OAuth",
  "ConnectorsPanel.oauthDescription": "These sign you in through the provider's own consent screen using an OAuth app you register once, and save an account — identity and granted scopes, proven live. That is a different connection from the App connectors grid above, which adds an MCP server instead; the two share no credential.",
  "ConnectorsPanel.googleDriveCopy": "Signs in with your Google account and requests read-only Drive metadata. Proves which account consented; access and refresh tokens stay in your OS keychain.",
  "ConnectorsPanel.microsoftGraphCopy": "Signs in with your Microsoft work or school account and requests read-only Files and Sites access via Microsoft Graph. A public client — no client secret.",
  "ConnectorsPanel.linearCopy": "Signs in to Linear with the read scope and records the Linear user who consented.",
  "ConnectorsPanel.asanaCopy": "Signs in to Asana with the users:read scope and records the Asana user who consented.",
  "ConnectorsPanel.dropboxCopy": "Signs in to Dropbox with read-only account and file-metadata scopes, requesting a long-lived refresh token.",
  "ConnectorsPanel.boxCopy": "Signs in to Box and records the Box login. Box scopes are set on your app in the Box developer console rather than requested here.",
  "ConnectorsPanel.airtableCopy": "Signs in to Airtable with read-only email and base-schema scopes. Airtable requires PKCE, is connected as a public client with no secret, and publishes no revoke endpoint — revoke in Airtable's own settings.",
  "ConnectorsPanel.zendeskCopy": "Signs in to your Zendesk subdomain with the read scope. Older Zendesk OAuth clients issue a token that never expires and has no refresh token.",
  "ConnectorsPanel.hubspotCopy": "Signs in to HubSpot and records which portal consented. HubSpot publishes no revoke endpoint this app can call — revoke in HubSpot's app settings.",
  "ConnectorsPanel.discordCopy": "Signs in to Discord with the identify scope and records the Discord user who consented.",
  "ConnectorsPanel.gitlabCopy": "Signs in to GitLab.com or your own internet-reachable GitLab with the read_user scope. A GitLab that only resolves to a private address is refused by the connector's SSRF policy.",
  "ConnectorsPanel.oauthRedirectUriLabel": "Redirect URI to register",
  "ConnectorsPanel.oauthRedirectUriHint": "Register this exact URI as the redirect URI of your OAuth app — it never changes for this provider.",
  "ConnectorsPanel.oauthRedirectUriCopy": "Copy",
  "ConnectorsPanel.oauthRedirectUriCopied": "Copied",
  "ConnectorsPanel.oauthClientIdPlaceholder": "OAuth client ID — blank reuses the app you already registered",
  "ConnectorsPanel.oauthClientSecretPlaceholder": "Client secret",
  "ConnectorsPanel.oauthSecretHint_required": "This provider's token endpoint requires the client secret. Both are saved in your OS keychain — leave both fields blank to reuse the app you already registered for this provider.",
  "ConnectorsPanel.oauthSecretHint_optional": "Leave the secret blank if you registered a public client. Both are saved in your OS keychain — leave both fields blank to reuse the app you already registered for this provider.",
  "ConnectorsPanel.oauthSecretHint_never": "Connect this provider as a public client: register your OAuth app without a client secret, because this app never sends one. The client ID is saved in your OS keychain — leave it blank to reuse the app you already registered for this provider.",
  "ConnectorsPanel.oauthConnectButton": "Connect",
  "ConnectorsPanel.oauthCancelButton": "Cancel sign-in",
  "ConnectorsPanel.oauthHostPlaceholderGitlab": "GitLab host, e.g. gitlab.com",
  "ConnectorsPanel.oauthHostPlaceholderZendesk": "Zendesk host, e.g. acme.zendesk.com",
  "ConnectorsPanel.oauthHostPlaceholderMicrosoft": "Tenant (optional), e.g. common or contoso.onmicrosoft.com",
  ...
  "KnowledgePanel.v2Badge_fresh": "Knowledge 2.0",
  "KnowledgePanel.v2Badge_stalePipeline": "2.0 · settings changed",
  "KnowledgePanel.v2Badge_staleSources": "2.0 · sources changed",
  "KnowledgePanel.v2Badge_unknown": "2.0 · freshness unknown",
  ...
  "UsagePanel.warningThresholds": "Warn at (%, comma-separated)",
  "UsagePanel.tierCrossed": "Highest threshold crossed: {{percent}}",
  "UsagePanel.enforcement": "At the limit",
  "UsagePanel.enforcementWarn": "Warn only",
  "UsagePanel.enforcementPause": "Pause cloud calls",
  "UsagePanel.todaySpend": "Known spend today",
  "UsagePanel.monthSpend": "Known spend this month",
  "UsagePanel.accountingStatus": "Budget status",
  "UsagePanel.costStatus.disabled": "Budget disabled",
  "UsagePanel.costStatus.ok": "Within budget",
  "UsagePanel.costStatus.warning": "Approaching limit",
  ...
  "UsagePanel.colDevice_wallTimeMs": "Wall time",
  "UsagePanel.colDevice_cpuTimeMs": "CPU time",
  ...
  "DesktopControlPanel.title": "Computer Use",
  "DesktopControlPanel.disabledDescription": "Lets the model control explicitly granted native applications through semantic inspection, bounded screenshots, and verified mouse/keyboard actions. It is off by default and never starts from bypass mode.",
  "DesktopControlPanel.enabledDescription": "Computer Use still requires an active application/window grant. Actions are approved individually unless you explicitly choose approved-batch mode; sensitive targets and OS security dialogs are always blocked.",
  "DesktopControlPanel.enableLabel": "Enable Computer Use",
  "DesktopControlPanel.enableDescription": "Expose the native Computer Use tools for this feature. Starting a session still requires an explicit local grant and a visible indicator.",
  ...
  "DesktopControlPanel.sessionStarted": "Session started. The control overlay is now visible.",
  ...
  "DictationButton.start": "Start dictation",
  "DictationButton.dictate": "Dictate",
  "DictationButton.startAriaLabel": "Start dictation",
  "DictationButton.stop": "Stop dictation",
  "DictationButton.starting": "Starting dictation",
  "DictationButton.unavailable": "Speech recognition unavailable",
  "DictationButton.cancelled": "Dictation cancelled",
  "DictationButton.manualEdit": "Dictation stopped because the composer was edited",
  "DictationButton.unmounted": "Dictation ended",
  "VoiceSettings.composerDictation": "Composer dictation",
  "VoiceSettings.composerDictationDescription": "Use the operating system's speech recognition to place editable text in the composer. Audio is not sent to the selected model.",
  "VoiceSettings.recognition": "Recognition",
  "VoiceSettings.systemSpeechRecognition": "System speech recognition",
  "VoiceSettings.language": "Language",
  "VoiceSettings.systemDefault": "System default",
  "VoiceSettings.requireOnDevice": "Require on-device recognition",
  "VoiceSettings.onDeviceUnavailable": "On-device recognition is unavailable for the selected language.",
  "VoiceSettings.speechRecognitionUnavailable": "Native speech recognition is unavailable on this platform."
};
