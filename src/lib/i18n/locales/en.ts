...
export const en: Record<string, string> = {
  ...
  "RulesMemoryPanel.memoryClearConfirmPrompt": "Delete every remembered fact for this project — not just the {{count}} listed here, but also any that are disabled, expired, or kept only so a merge can be undone? This can't be undone.",
  ...
  "MemoryStudioPanel.retiredReason": "Merged into another memory {{date}} — kept so the merge can be undone, never sent to the model, and never removed by Purge expired.",
  ...
  "MemoryStudioPanel.purgeComplete": "Purged {{count}} expired memories, across every scope.",
