...
export const en: Record<string, string> = {
  ...
  "KnowledgePanel.reindexFeedsFallbackOnly":
    "Knowledge 2.0 answers searches for this stack. Reindexing refreshes the older index it falls back to, not the one being read.",
  ...
  "UsagePanel.warningThreshold": "Warn at (%)",
