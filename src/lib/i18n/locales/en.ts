...
export const en: Record<string, string> = {
  ...
  "ConnectorsPanel.oauthSecretRequiredHint": "This provider's token endpoint requires the client secret. Both are saved in your OS keychain, so the next account for this provider is one click.",
  "ConnectorsPanel.oauthSecretOptionalHint": "Leave the secret blank if you registered a public client. Both are saved in your OS keychain, so the next account for this provider is one click.",
