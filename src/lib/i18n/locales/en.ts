export const en: Record<string, string> = {
  ...
  "AutomationPanel.verifyEnabledDescription": "After a reply that changes files, automatically run this workspace's enabled commands below and show the results — nothing is fed back to the model yet.",
