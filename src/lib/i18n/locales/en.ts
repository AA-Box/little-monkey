export const en: Record<string, string> = {
  ...
  "ScheduledTasksPanel.description": "Saved recipes — YAML tasks with a prompt, model target, and permission policy — runnable here or headlessly via `monkey-cli task run`.",
