export const en: Record<string, string> = {
  ...
  "ApiServerPanel.portHint": "Stop and start the server again to apply a new port.",
  ...
  "ApiServerPanel.tokenHint": "Required on every request (Authorization: Bearer …). Regenerated each time the server starts — copy it again after a restart. Full token management (multiple scoped tokens) is coming soon.",
  "ApiServerPanel.authWarning": "Any local app with this token can chat through your locally managed models. Cloud providers are never exposed here."
};
