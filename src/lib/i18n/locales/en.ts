...
export const en: Record<string, string> = {
  ...
  "ConnectorsPanel.appClientIdHint": "One-time setup — saved after you connect, so future reconnects are one click.",
  "ConnectorsPanel.appOauthPhase_discovering": "Discovering OAuth server…",
  "ConnectorsPanel.appOauthPhase_needs_client_id": "Client ID required",
