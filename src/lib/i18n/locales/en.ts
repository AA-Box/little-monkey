...
export const en: Record<string, string> = {
  ...
  "McpPanel.templateSlackDetail": "Little Monkey does not register the Slack OAuth app for you. Use this only with an approved client identity and an existing compatible bearer token.",
  ...
  "McpPanel.templateAtlassianDetail": "OAuth setup is not automated here. This starter works only when your Atlassian site accepts an existing compatible bearer token, such as an approved service-account flow.",
