...
export const dailyBriefLocale: Record<string, string> = {
  ...
  "DailyBriefPanel.connectors.sourcesTitle": "Brief connector sources",
  "DailyBriefPanel.connectors.sourcesDescription": "Only connected, explicitly enabled, read-only MCP tools are queried. Their output is shown as bounded untrusted evidence.",
  "DailyBriefPanel.connectors.readTool": "Connected read-only tool",
  "DailyBriefPanel.connectors.noReadTool": "No connected read-only MCP tool is available",
  "DailyBriefPanel.connectors.sourceLabel": "Highlight label (optional)",
  "DailyBriefPanel.connectors.arguments": "Tool arguments (JSON object)",
  "DailyBriefPanel.connectors.argumentsObjectError": "Arguments must be a JSON object.",
  "DailyBriefPanel.connectors.addSource": "Add to brief",
  "DailyBriefPanel.connectors.removeSource": "Remove connector source",
